        ...
        <div className="about__container-paragraph">
          <main className="about__paragraph">
            ...
            {/* <p className="about__break">
              ...
              &nbsp;transitioned me from physically managing massive
              construction projects to building digital homes and experiences.
            </p> */}
            <p className="about__break">
          ...
          <div className="about__paragraph">
            ...
            <ul>
              <li className="about__break">
                ...
                “know a person who can fix that thing.” (I aim for that person
                to be me in every circumstance, whether plumbing, or code.)
              </li>
              <li className="about__break">
              ...
              <li className="about__break">
                I'm notorious for my front-to-back-to-side-and-under knowledge
                of podcasts. Fave right now? Syntax: because Javascript.{' '}
              </li>
              <li className="about__break">
